...
public class QEvent extends com.mysema.query.sql.RelationalPathBase<QEvent> {
    ...
    public void addMetadata() {
        ...
        addMetadata(eventTypeId, ColumnMetadata.named("EVENT_TYPE_ID").ofType(-5).withSize(19));
        addMetadata(resourceId, ColumnMetadata.named("RESOURCE_ID").ofType(-5).withSize(19));
        addMetadata(saveTimestamp, ColumnMetadata.named("SAVE_TIMESTAMP").ofType(93).withSize(23).withDigits(10));
    }
